...
<div id="container">  
  ...
  <div id="main">
    <div id="breadcrumb">
      » <a href="index.html">Home</a> » <a href="table.php">Data table</a> » <a href="browse.php?page=1">Gene list</a> » Gene information
    </div>
	<div id="contentData"> 
...
<?php
  ...
  $sql= "select t1.acc, t1.code, t1.ac, t1.oi, t1.loc, t1.gc, t1.fra, t1.str, t1.gi, t1.cog, t1.deb, t1.os, t1.oa, t2.gn, t3.sq, t4.aa, t5.oa, t5.ncgi, t5.tax, t5.osftp, t5.lineage, t5.gsmn, t5.disease from coreannotation as t1, degannotation5p as t2, degseq5p as t3, degaa5p as t4, coreorganism as t5 where trim(t1.ac)=trim(t2.ac) and trim(t2.ac)=trim(t3.ac) and trim(t3.ac)=trim(t4.ac) and trim(t1.acc)=\"".trim($acc)."\" and trim(t1.oa)=trim(t5.oa)";             
  ...
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
		...
		<tr> 
		  <td width="10%" rowspan="15">Gene information</td>
