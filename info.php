...
<title>Leading-Strand Essential Gene Information</title>
...
<table id="geneInfo" cellspacing="2" cellpadding="2">
  <tr> 
    <td class="tableHeader">&nbsp;&nbsp;Information of the leading-strand essential gene</td>
  </tr>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="4">
		...
		<tr> 
          ...
          <td>
		    <? 
			   $gi = trim($arr[gi]);
		       echo "<a href=\"http://www.ncbi.nlm.nih.gov/protein/$gi\" target='_blank'>";
			   echo $gi;
			   echo "</a>\n";
			?>			
		  </td>
