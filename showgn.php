...
# $sql= "select t1.acc, t1.ac, t1.code, t1.gnb, t1.oi, t1.cog, t1.deb, t1.os, t1.oa from coreannotation as t1 where trim(t1.oa)=\"NC_005966\" and trim(t1.code)=\"D\"";
 $sql= "select t1.acc, t1.ac, t1.code, t1.oi, t1.cog, t1.deb, t1.os, t1.oa, t2.ac, t2.gn from coreannotation as t1, degannotation5p as t2 where trim(t1.oa)=\"$oa\" and trim(t1.code)=\"$code\" and trim(t1.ac)=trim(t2.ac) order by trim(t2.gn)";
    ...
    <td width="20%"><div align="right">
     <? #display "Previous page".
		if(($current_page-1)>= 1){
			...
			echo "<a href=\"showgn.php?oa=$oa&code=$code&page=$previous_page\">";
		...
		if($page_number>1){
			for($j=1; $j <= $page_number; $j++){
				if($j==$current_page){
					...
					echo "<a href=\"showgn.php?oa=$oa&code=$code&page=$j\">";
		...
		if(($current_page+1)<=$page_number){
			...
			echo "<a href=\"showgn.php?oa=$oa&code=$code&page=$next_page\">";
